...
<div id="toolbar_div">
    ...
    <div class="toolbarR">
        <a onclick="parent.toActive('menu_setting');" href="device_list.php?mode=<?php if(isset($_SESSION["user_id"]) && !empty($_SESSION["user_id"])) echo "personal"; else echo "public"; ?>">
    ...
    <div id="my_account_list" class="left_list">
        ...
        //remark to disable password change
				...
				<tr class="odd">
					<td>' . _("Password") .'</td>
					<td>
						<input id="pwd-edit" class="full_size_input" disabled type="password" autocomplete="off" maxlength="32" placeholder="預設密碼" />
					</td>
				</tr>
				<tr class="even">
					<td>'. _("Confirm Password") .'</td>
					<td>
						<input id="pwd_confirm-edit" class="full_size_input" disabled type="password" autocomplete="off" maxlength="32" placeholder="預設密碼" />
					</td>
				</tr>
				';
			}
