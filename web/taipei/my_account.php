    ...
    <div id="my_account_list" class="left_list">
        ...
        //remark to disable password change
				...
				<tr class="odd">
					<td>' . _("Password") .'</td>
					<td>
						<input id="pwd-edit" class="full_size_input" disabled type="password" autocomplete="off" maxlength="32" />
					</td>
				</tr>
				<tr class="even">
					<td>'. _("Confirm Password") .'</td>
					<td>
						<input id="pwd_confirm-edit" class="full_size_input" disabled type="password" autocomplete="off" maxlength="32" />
					</td>
				</tr-->
				';
			}
