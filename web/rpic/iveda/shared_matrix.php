 ...
 *set auto Cycle default enabled for 300s = 5mins
...
include_once( "./include/global.php" );
include_once( ROOT_PATH . "/include/utility.php" );
include_once( ROOT_PATH . "/include/index_title.php" );
include_once( OEM_PATH . "/include/index_title.php" );

if (!IsUserLoggedIn()) {header('Location: ' . ROOT_URL . 'login.php?oem-url=' . OEM_URL); exit;}
?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<!--[if lt IE 7 ]> <html class="ie6" xmlns="http://www.w3.org/1999/xhtml" id="html_device_matrix"> <![endif]-->
<!--[if IE 7 ]>    <html class="ie7" xmlns="http://www.w3.org/1999/xhtml" id="html_device_matrix"> <![endif]-->
<!--[if IE 8 ]>    <html class="ie8" xmlns="http://www.w3.org/1999/xhtml" id="html_device_matrix"> <![endif]-->
<!--[if IE 9 ]>    <html class="ie9" xmlns="http://www.w3.org/1999/xhtml" id="html_device_matrix"> <![endif]-->
<!--[if (gt IE 9)|!(IE)]><!--> <html class="" xmlns="http://www.w3.org/1999/xhtml" id="html_device_matrix"> <!--<![endif]-->
<head>
...
<?php require( ROOT_PATH . "/include/common_css_include.php" ); ?>
<?php require( ROOT_PATH . "/include/common_js_include.php" ); ?>
...
<link href="<?php echo ROOT_URL ?>shadowbox-3.0.3/shadowbox.css?20120708" rel="stylesheet" type="text/css" charset="utf-8">

<script type="text/javascript" src="<?php echo ROOT_URL ?>js/jquery.client.js"></script>
<script type="text/javascript" src="<?php echo OEM_URL ?>js/device_common.js?20140331"></script>
<script type="text/javascript" src="<?php echo ROOT_URL ?>js/deployJava.js"></script>
<script type="text/javascript" src="<?php echo ROOT_URL ?>js/page_control.js?20120526"></script>
<script type="text/javascript" src="<?php echo ROOT_URL ?>js/jquery.media.js"></script>
<script type="text/javascript" src="<?php echo ROOT_URL ?>js/jquery-ui.min.js"></script>
<script type="text/javascript" src="<?php echo ROOT_URL ?>js/customSort.js"></script>
<script type="text/javascript" src="<?php echo OEM_URL ?>js/java_vlc_control.js?20120567"></script>
<script type="text/javascript" src="<?php echo OEM_URL ?>js/device_matrix.js?20130906"></script>
<script type="text/javascript" src="<?php echo ROOT_URL ?>shadowbox-3.0.3/shadowbox.js"></script>
<script type="text/javascript" src="<?php echo ROOT_URL ?>js/googleRelay.js?20120605"></script>
<script type="text/javascript">
	...
	$(function(){
	 ...
	 <?php //jinho add for default enable 5 mins
		echo "g_page_control_auto_cycle_interval = setInterval(AutoCycleNext, 300000);"; 
		?>
	});

    $(window).on('resize', UpdateBoxContentHeight);
    parent.$('body').addClass('hide-banner');
</script>
</head>
<body>
...
<div class="device_matrix_container">
    <div id="device_matrix" class="clearfix left_list"></div>
</div>
	...
	<div id="whole_button_cover">
        ...
        <div id="_page_button">
            <div class="center_cover">
                ...
                <span id='auto_cycle'>
                    <div id='cb_auto_cycle' class='_checkbox-enable' style='display: inline-block'></div><?php echo _("Auto Cycle");?>
                </span> 
            </div>
        </div>
        <div class="_window_buttons align_center">
            <div class="btn_sharef btn_sharef-inline-block" title="<?php echo _('Close') ?>" onclick="CloseWindow();"><?php echo _('Close') ?></div>
        </div>
    </div>
</div>
<?php include_once(ROOT_PATH . "/include/tail.php"); ?>
</body>
</html>
