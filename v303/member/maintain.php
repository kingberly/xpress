...
//SELECT VERSION();
  ...
  $sql = "UPDATE $table SET Password=ENCODE(:password,:key), Contact=:contact, Mobile=:mobile, Company_english=:company_english, Company_chinese=:company_chinese, Address=:address WHERE Email=:email";
