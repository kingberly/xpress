...
$sql="select * from qlync.menu where Name = 'Festival Info'";
...
echo "<div align=center><font size=6> "._("Festival Info")."</font></div>";
...
//echo "<div align=center><font size=6> "._("Upload  Info")."</div>";
