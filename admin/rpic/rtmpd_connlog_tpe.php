<?php
/****************
 *Validated on May-15,2017,
 * log rtmp connection number in /var/tmp/rtmp_connection_t04.log
 * Sync with rtmpd_connlog_Const.php    
 *Writer: JinHo, Chang
*****************/
define("LOG_FILE","rtmpd_connection_t04.log");
...
if (!isset($rtmpArray)){
  ...
  //if(date("jG") == "10") //first day 0 hour will change file
