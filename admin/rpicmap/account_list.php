 ...
 * revised from account_list.php, limit for SCID002, AID 2
 * remove serach form
 * remove page  
 *Writer: JinHo, Chang
******************/ 
  ...
  {
    {
      ...
      echo "<tr class=tr_".($row%2+1).">";  
        ...
        echo "<td nowrap>";
         //jinho added List
            echo "<a href=\"javascript: window.open('/plugin/debug/playback_list.php?debugadmin&user={$key}&mac=".$value[mac][$li]."','',config='height=650,width=600');\">".$value[mac][$li]."</a>";
