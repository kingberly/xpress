...
echo "<table class=table_main>\n";
    ...
    if ($uidstats[$value["uid"]] =="ON"){//jinho
      ...
      echo "<font color=red>Version: NA</font><HR><font color=#0000CC>Region : {$region_name[$value[region]]}</font>";
    }
...
//			echo "port:{$value["stats"]["port"]}\n";
    ...
    if ($uidstats[$value["uid"]] =="ON"){//jinho
      ...
      echo "<font color=red>CPU : NA<BR>MEM : NA<BR>DISK:\n</font>";
    }
		echo "</td>\n";
/* //jinho remove below error inquiry
