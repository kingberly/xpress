#!/usr/bin/python
#sudo apt-get -y install python-software-propertie
#kill streaming if more than 3 minutes from same IP
...
import subprocess
import platform
#netstat -tn 2>/dev/null | grep :5544 |awk '{print $5}' | cut -d: -f1|grep -v '192.168'
#netstat -tn 2>/dev/null | grep :5544 |awk '{print $5}' | cut -d: -f1|grep -v '192.168'|while read line; do ipset add vader $line;ipset add pass $line ;done

#-------------------print out as below---------------
#['28:', 'haproxy', '192.168.1.102:5547', '61.216.61.162:12119', 'ESTABLISHED', None, None]
